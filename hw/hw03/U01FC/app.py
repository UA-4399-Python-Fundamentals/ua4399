...
print(f"better count: {ZEN.count("better")}")
print(f"never count: {ZEN.count("never")}")
print(f"is count: {ZEN.count("is")}")
print(ZEN.upper())
print(ZEN.replace("i", "&"))
...
NATURAL_NUMBER = 6576
string_number = str(NATURAL_NUMBER)
product = (int(string_number[0]) * int(string_number[1]) * int(string_number[2]) * int(string_number[3]))
print(f"product: {product}")
print(f"reverse: {string_number[::-1]}")
listed = list(string_number)
listed.sort()
print(f"sorted: {listed}") 
